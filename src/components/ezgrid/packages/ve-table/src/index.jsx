...
export default {
        ...
        getVirtualViewPhantom() {
            ...
            */
            ...
            if (isVirtualScroll || (hasLeftFixedColumn && expandOption)) {
                ...
                // yvan
                console.log('virtualViewPhantom', props)
    ...
    created() {
        // bug fixed #467
        this.debouncedBodyCellWidthChange = _.debounce(
    ...
    render() {
        ...
        // yvan
        console.log('tableRootProps', tableContainerWrapperProps, tableContainerProps, tableWrapperProps)

        return (
            <div {...tableRootProps}>
                <VueDomResizeObserver {...tableContainerWrapperProps.props} {...tableContainerWrapperProps}>
                    <div {...tableContainerProps}>
                        {/* virtual view phantom */}
                        {this.getVirtualViewPhantom()}
                        {/* vue 实例类型，访问dom时需要通过$el属性访问 */}
                        <VueDomResizeObserver {...tableWrapperProps.props} {...tableWrapperProps}>
                            <table {...tableProps}>
                                {/* colgroup */}
                                <Colgroup
                                    colgroups={colgroups}
                                ...
                                />
                                {/* table header */}
                                {showHeader && <Header {...headerProps.props} {...headerProps} />}
                                {/* table body */}
                                <Body {...bodyProps.props} {...bodyProps} />
                                {/* table footer */}
                                <Footer {...footerProps.props} {...footerProps} />
                            </table>
                            {/* cell selection */}
                            {enableCellSelection && (
                                <Selection {...selectionProps.props} {...selectionProps} />
                            )}
                        </VueDomResizeObserver>
                    </div>
                    {/* edit input */}
                    {enableCellSelection && <EditInput {...editInputProps.props} {...editInputProps} />}
                    {/* contextmenu */}
                    {(this.enableHeaderContextmenu ||
                        this.enableBodyContextmenu) && (
                        <VeContextmenu {...contextmenuProps.props} {...contextmenuProps} />
                    )}
                    {/* column resizer */}
                    {enableColumnResize && (
                        <ColumnResizer {...columnResizerProps.props} {...columnResizerProps} />
                    )}
                </VueDomResizeObserver>
            </div>
        );
